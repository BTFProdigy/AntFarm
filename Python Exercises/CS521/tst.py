...
def create_checkbox(a_border_width=5, a_height=150):
    '''
    ...
    the_frame = ttk.Frame\
        (the_content, borderwidth = a_border_width, relief="sunken", width=200, height=a_height)
    ...
    student_box = ttk.Checkbutton \
        (the_content, text="Student", variable=student_bool)
    auditor_box = ttk.Checkbutton \
        (the_content, text="Auditor", variable=auditor_bool)
    admin_box = ttk.Checkbutton \
        (the_content, text="Admin", variable=admin_bool)
    ...
    ok_button = ttk.Button\
        (the_content, text="OK",
         command=lambda: simulated_entered(student_bool.get()))
